...
public class ClientePOP3 {
	...
	try{
		...
		System.out.println("Enviando contraseña");
		...
		while (continuar) {
			...
			switch (orden) {
					...
					// CUIDADO: NextLine usando TCP sólo devuelve FALSE si 
					// se corta la conexíon, de lo contrario siempre devuelve
					// true, por ello no sirve para el While, en comparación
					// la respuesta del servidor SMTP te lista las cosas acabando
					// siempre con un punto, partiendo de ahí puedes comparar línea
					// a línea
