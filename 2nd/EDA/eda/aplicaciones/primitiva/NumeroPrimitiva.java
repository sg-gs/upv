...
/**
 * NumeroPrimitiva: representa un numero entero entre el 1 y el 49, elegido
 * aleatoriamente.
 *
...
public class NumeroPrimitiva implements Comparable<NumeroPrimitiva> {
    ...
    /**
     * Crea un NumeroPrimitiva eligiendo aleatoriamente un numero del intervalo
     * entero [1, 49].
     */
    ...
    /**
     * Comprueba si un (this) NumeroPrimitiva es igual a otro, i.e. si ambos tienen
     * el mismo valor
     * 
     * @param otro el otro NumeroPrimitiva.
     * @return true si this y otro tienen el mismo valor y false en caso contrario
     */
     ...
     * @return int < 0 si this es menor que otro, int > 0 si this es mayor que otro
    ...
    /**
     * Devuelve el String que representa un (this) NumeroPrimitiva en formato texto
     * 
