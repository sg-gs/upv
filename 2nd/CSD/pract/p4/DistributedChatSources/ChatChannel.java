...
//
public class ChatChannel extends UnicastRemoteObject implements IChatChannel {
   ...
   //
   // When users leave or join this channel, we send a message to the remaning
   // users, so that
