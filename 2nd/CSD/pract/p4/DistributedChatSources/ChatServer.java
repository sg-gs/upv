...
public class ChatServer extends UnicastRemoteObject implements IChatServer {
   ...
   //
   // ISA IChatServer
   // Returns a named channel. If not found or stale, returns null. If stale,
   // removes it.
   //
   ...
   //
   // ISA IChatServer
   // Returns a named user. If not found or stale, returns null. If stale, removes
   // it.
   //
   ...
   public synchronized boolean disconnectUser(IChatUser usr) throws RemoteException {
      ...
      // User found and it was the same as the argument.... so remove it from server
      // and channels
      users.remove(nick);
